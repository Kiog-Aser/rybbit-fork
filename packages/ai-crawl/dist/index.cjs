...
__export(index_exports, {
  AI_CRAWLER_CATEGORY: () => AI_CRAWLER_CATEGORY,
  classifyAICrawlerUserAgent: () => classifyAICrawlerUserAgent,
  createAICrawlerMiddleware: () => createAICrawlerMiddleware,
  createExpressAICrawlerMiddleware: () => createExpressAICrawlerMiddleware,
  shouldTrackAICrawlerRequest: () => shouldTrackAICrawlerRequest,
  trackAICrawlerRequest: () => trackAICrawlerRequest,
  trackAICrawlerRequestInBackground: () => trackAICrawlerRequestInBackground,
  trackAICrawlerResponse: () => trackAICrawlerResponse,
  withAICrawlerTracking: () => withAICrawlerTracking
});
