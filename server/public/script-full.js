...
(() => {
  ...
  var Tracker = class {
    ...
    deriveAttributionChannel(referrer, querystring, hostname) {
      const params = new URLSearchParams(querystring.startsWith("?") ? querystring : `?${querystring}`);
      const utmSource = params.get("utm_source")?.toLowerCase() || "";
      const utmMedium = params.get("utm_medium")?.toLowerCase() || "";
      const paidMediums = /* @__PURE__ */ new Set(["cpc", "ppc", "paid", "paidsearch", "display", "retargeting"]);
  ...
  (async function() {
    ...
    window[config.namespace] = {
      ...
      getStripeMetadata: () => tracker.getStripeMetadata(),
