...
export const DISABLE_SIGNUP = process.env.DISABLE_SIGNUP === "true" || BOOTSTRAP_ADMIN_MODE;
export const DISABLE_TELEMETRY = process.env.DISABLE_TELEMETRY === "true";
export const LITE_DASHBOARD = process.env.LITE_DASHBOARD === "true" || AKASH_LEAN_MODE;
