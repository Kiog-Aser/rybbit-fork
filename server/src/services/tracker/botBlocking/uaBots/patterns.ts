...
export const EXTRA_BOT_PATTERNS: BotPattern[] = [
  ...
  { pattern: "\\bgoogle-agent\\b", category: "ai" },
  { pattern: "\\bgoogle-cloudvertexbot\\b", category: "ai" },
  { pattern: "\\bgoogle-notebooklm\\b", category: "ai" },
  { pattern: "^claude-code/", category: "ai" },
  ...
  { pattern: "\\bgemini\\b", category: "ai" },
  { pattern: "\\bgoogleother\\b", category: "ai" },
  { pattern: "\\bgoogle-inspectiontool\\b", category: "ai" },
  { pattern: "\\bmeta-externalagent\\b", category: "ai" },
  { pattern: "\\bmeta-externalfetcher\\b", category: "ai" },
  { pattern: "\\bduckassistbot\\b", category: "ai" },
  { pattern: "\\bmistralai-index\\b", category: "ai" },
  { pattern: "\\banthropic-ai\\b", category: "ai" },
